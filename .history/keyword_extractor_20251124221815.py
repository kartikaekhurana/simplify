...
# Pre-trained models support (optional)
# To use pre-trained models, install: pip install transformers torch
# See PRETRAINED_MODELS.md for available models
TRANSFORMERS_AVAILABLE = False
try:
    from transformers import pipeline
    TRANSFORMERS_AVAILABLE = True
except ImportError:
    pass  # Using keyword-based approach (default)
...
def extract_tech_keywords(text):
   ...
   tech_keywords = [
    ...
    'fastapi', 'nextjs', 'nestjs', 'laravel', 'php', 'go', 'rust', 'c++',
    'c#', '.net', 'swift', 'kotlin', 'react native', 'flutter', 'opencv',
    'nlp', 'llm', 'big data', 'spark', 'hadoop', 'airflow', 'snowflake',
    'databricks', 'ci', 'cd', 'firebase', 'supabase', 'postgres', 'oracle'
    ]
...
def detect_domain(text):
    ...
    Uses keyword-based approach (fast and reliable).
    For ML-based approach, see PRETRAINED_MODELS.md
    """
    text_lower = text.lower()
