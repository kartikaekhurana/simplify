...
Generates interview questions based on domain and seniority level
"""
...
def generate_interview_questions(domain, seniority, tech_keywords=None):
    """
    Generate interview questions based on domain and seniority level.
    
    Args:
        domain: Professional domain (e.g., "Software Engineering / Full Stack")
        seniority: Seniority level (e.g., "Senior", "Mid-Level")
        tech_keywords: List of technology keywords from resume
